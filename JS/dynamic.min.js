let row=document.getElementById("portfolioRow");let modelIds=['exampleModalLabelOne','exampleModalLabelTwo','exampleModalLabelThree','exampleModalLabelFour','exampleModalLabelFive','exampleModalLabelSix'];let modelCardHeader=["One","Two","Three","Four","Five","Six"];let modelCardImgs=['img/1.jpg" class="card-img-top','img/2.jpg" class="card-img-top','img/3.jpg" class="card-img-top','img/4.jpg" class="card-img-top','img/5.jpg" class="card-img-top','img/6.jpg" class="card-img-top'];let modelCard='';for(let i=0;i<=5;i++){modelCard+=`<div class="col-12 col-md-6 col-lg-4">
